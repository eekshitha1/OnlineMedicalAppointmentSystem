...
<!--  <li><a href="RegisterAccount.jsp" >Patient Registration</a></li> -->
<li><a href="ViewFAQPage.jsp" >FAQS</a></li>
			...
			<center>
<form name="f1" method="post" action="LoginPatient" onsubmit="return checkFields(this);"><br/>
   <h2><b>Patient Login Page</b></h2>
	...
	<form name="f2" action="RegisterAccount.jsp">	
	<table align="center" width="40" >	
	<div>
