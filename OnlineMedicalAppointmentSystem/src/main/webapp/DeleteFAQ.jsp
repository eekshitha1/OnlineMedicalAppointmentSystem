...
<li><a href="index.jsp" >SignOut</a></li>
	...
	<table border="1" align="center" width="100%" >
         ...
         <tr>
		 <th><font  color="black">FAQ ID</th>
		 <th><font  color="black">Question</th>
		 <th><font  color="black">Answer</th>
		 <th><font  color="black">Delete FAQ</th>
		</tr>
		 
		 <%
		Connection dbcon = Database.connectionDriver();
		Statement s=dbcon.createStatement();
		ResultSet rs=s.executeQuery("select * from frequentquestion");
		while(rs.next()){
		...
		<td><a href="DeleteFAQ?id=<%=rs.getString(1)%>"><font color="black">Click Here</font></a></td>
	<%}%>
</p>
</table>
